...
- Keep the pull model and fencing semantics intact: expiry is uncertain, stale tickets remain unavailable, and only explicit takeover changes ownership/generation.
