...
- Keep the pull model and fencing semantics intact: claims persist without liveness inference, and only explicit release, submission, or takeover removes current authority.
