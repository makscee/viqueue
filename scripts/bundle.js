...
for (const file of ['bin/viq.js', 'bin/viq-import.js', 'bin/viq-phone-auth.js', 'bin/viq-trace-tailscale-upstream.js', 'src/server.js', 'src/store.js', 'src/http-client.js', 'src/mcp-server.js', 'src/phone-auth-store.js', 'src/phone-gateway.js', 'package.json']) {
