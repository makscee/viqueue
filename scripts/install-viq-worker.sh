...
[[ -f $stage/package.json && -f $stage/extensions/viq-worker/index.ts && -f $stage/extensions/viq-worker/worker-runtime.mjs && -f $stage/extensions/viq-worker/credential-store.mjs ]] || { echo 'worker package is incomplete' >&2; exit 1; }
