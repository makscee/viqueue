...
const bundle=(extra={})=>({version:1,summary:'Implemented the requested result.',evidence:[{kind:'commit',label:'Candidate',uri:'urn:git:abc',digest:'sha256:abc'}],verification_steps:['Open the ticket and inspect the result.'],tests:[{name:'unit',status:'passed',uri:'urn:test:unit'}],caveats:[],ui_change:false,source:{commit:'abc'},release:{status:'not-released'},...extra});
