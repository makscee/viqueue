...
test('origin must be an exact canonical HTTPS origin',()=>{for(const bad of ['http://phone.test','https://user@phone.test','https://phone.test/path','https://phone.test/?q=1','https://phone.test/#x','https://phone.test/','HTTPS://phone.test','https://PHONE.test'])assert.throws(()=>new AuthStore('/tmp/unused.sqlite',{origin:bad}),/canonical/);assert.equal(new AuthStore('/tmp/unused.sqlite',{origin:'https://phone.test:7443'}).origin,'https://phone.test:7443')});
